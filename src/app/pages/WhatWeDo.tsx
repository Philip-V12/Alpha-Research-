...
export function WhatWeDo() {
  ...
  const bannerServices = [
    ...
    },
    {
      ...
      tools: [
        ...
        { name: 'Chapters', link: '/services/chapter-writing' },
        { name: 'Editing', link: '/services/thesis-editing' },
        { name: 'Statistics', link: '/services/statistical-analysis' }
      ],
    ...
    },
    {
      ...
      tools: [
        ...
        { name: 'Manuscript Writing', link: '/services/manuscript-writing' },
        { name: 'Methodology', link: '/services/research-methodology' },
        { name: 'Research Gap', link: '/services/research-gap-analysis' }
      ],
  ...
  return (
    <div className="min-h-screen bg-white">
      <Seo
        title="What We Do | Alpha Research Academic Consultancy"
        description="Discover what Alpha Research does: statistical analysis, engineering simulation, academic formatting, journal publication, and end-to-end PhD thesis and dissertation support across MATLAB, SPSS, ANSYS, and LaTeX."
        keywords={['what we do', 'academic research services', 'thesis statistics', 'engineering simulation', 'journal publication', 'PhD thesis support', 'academic formatting']}
      />
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4 md:mb-6">How We Support Your Research</h2>
            <p className="text-lg md:text-2xl text-gray-600 max-w-3xl mx-auto">
              Complete research, content development, and publishing support — explore our full service catalogue on the <Link to="/services" className="text-teal-600 font-semibold hover:underline">Services</Link> page.
            </p>
          </div>
