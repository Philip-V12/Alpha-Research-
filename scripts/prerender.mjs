...
const ROUTES = [
  '/', '/about', '/services', '/what-we-do', '/contact',
  // New categorized service item pages
  '/services/statistical-analysis', '/services/spss-analysis', '/services/data-analysis',
  '/services/r-programming', '/services/computer-science', '/services/engineering',
  '/services/management', '/services/nursing-healthcare', '/services/social-sciences',
  '/services/mathematics', '/services/manuscript-writing', '/services/abstract-writing',
  '/services/dissertation-writing', '/services/chapter-writing', '/services/research-gap-analysis',
  '/services/problem-identification', '/services/formatting', '/services/research-methodology',
  '/blog',
...
// Append all city location routes (generated by scripts/gen-locations.mjs).
try {
  const locSlugs = JSON.parse(readFileSync(join(__dirname, 'location-slugs.json'), 'utf8'));
  for (const s of locSlugs) ROUTES.push(`/blog/locations/${s}`);
  console.log(`[prerender] added ${locSlugs.length} location routes`);
} catch {
  console.warn('[prerender] location-slugs.json not found — skipping location prerender');
}
